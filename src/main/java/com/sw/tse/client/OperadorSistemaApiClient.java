...
@FeignClient(name = "operadorSistemaApiClient", url = "${api.tse.url}", configuration = OperadorSistemaClientConfig.class)
public interface OperadorSistemaApiClient {
    ...
    @PostMapping("/api/OperadorSistema/ResetarSenha/v2")
