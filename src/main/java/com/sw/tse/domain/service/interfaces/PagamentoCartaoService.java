...
public interface PagamentoCartaoService {
    ...
    /**
     * Processa um pagamento aprovado no portal, criando transação, conta
     * consolidada e negociação
     * 
     * @param dto Dados do pagamento aprovado
     * @return DTO com o resultado do processamento
     */
    ProcessamentoPagamentoResponseDto processarPagamentoAprovado(ProcessarPagamentoAprovadoTseDto dto);
}
