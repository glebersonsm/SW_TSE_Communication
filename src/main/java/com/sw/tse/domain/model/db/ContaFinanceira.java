...
public class ContaFinanceira {
    ...
    public static ContaFinanceira criarContaConsolidadaPagamentoPortal(
        ...
        if (isPix) {
            ...
            contaNova.pago = true;
            contaNova.dataPagamento = dataPagamento.toLocalDate().atStartOfDay(); // Sem hora
            contaNova.dataBaixa = dataLiquidacao.truncatedTo(ChronoUnit.SECONDS); // Com hora, sem nanossegundos
            contaNova.dataLiquidacao = dataLiquidacao.toLocalDate().atStartOfDay(); // Sem hora
            ...
            LocalDateTime dataVencimento = calcularDataVencimento(bandeiraCartao, dataLiquidacao);
